...
<jsp:include page="/WEB-INF/view/assignStudentCourse/common.jsp" />
...
<div id="initDiv">
	<form action="/assignStudentCourse/save" method="POST">
		<table id="tblShow">
	<thead>
	</thead>
	<tbody>
	...
	<input type="hidden" id="student_course_code" name="student_course_code"/>
	<input type="hidden" id="student_course_name" name="student_course_name"/>
...
$("#btnSearch").on("click", function() {
	$.ajax({
		...
		success : function(data, status) {
			...
			htmlHeader += "<th>Phone</th>";
			htmlHeader += "</tr>";

			for (i = 0; i < data.length; i++) {
				html += "<tr>";
				html += "<td><input type='checkbox'/><input name='student_id[]' type='hidden' value='"+data[i].sid+"'/></td>";
